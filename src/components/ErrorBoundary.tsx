    ...
    return (
      <div className="min-h-screen bg-bg text-text-main flex items-center justify-center p-6">
        <div className="w-full max-w-md rounded-3xl border border-border bg-card p-8 text-center shadow-xl">
          <h1 className="text-xl font-bold text-gold mb-3">Something went wrong</h1>
          ...
          <button
            ...
            className="w-full py-3.5 bg-gold text-bg font-bold rounded-2xl transition-colors hover:bg-gold/90"
          >
            Reload app
          </button>
          <button
